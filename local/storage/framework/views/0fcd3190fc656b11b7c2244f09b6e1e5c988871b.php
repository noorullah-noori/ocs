                                 ...
                                 <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                      ...
                                      <div class="form-group date_dari">
                                          ...
                                          <div class="col-lg-6">
                                            <input class="form-control change_date date_dr" id="date_dr" value="<?php echo e($the_president->date_dr); ?>"  name="date_dr" type="text" required>
                                          </div>
                                      </div>
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                      ...
                                      <div class="form-group date_dari">
                                          ...
                                          <div class="col-lg-6">
                                            <input class="form-control change_date date_dr" id="date_pa" value="<?php echo e($the_president->date_pa); ?>"  name="date_pa" type="text" required>
                                          </div>
                                      </div>
                                    <div class="form-group ">
