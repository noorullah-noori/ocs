   ...
   <div class="ui items" style="">
        ...
        ?>
            <div class="item <?php echo e(($item==$lattest_news->last())?'no_border':''); ?>">
              ...
              <div class="content">
                <a href="<?php echo e(($item->table_name=='documents' || $item->table_name=='album')?$url:url($lang.'/'.$item->type.'_details/'.$item->table_id)); ?>" class="ui small header title_font"><?php echo e($item->$title); ?></a>
                <div class="meta">
