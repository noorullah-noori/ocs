...
<div class="ui segment not-printable" style="margin-top:0;">
  <div class="ui equal width centered container grid" id="footer_content">
    <div class="sixteen wide tablet mobile five wide computer column" style="text-align:<?php echo e($indir); ?>">
...
<?php echo $__env->make('include.js_links', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <script>
