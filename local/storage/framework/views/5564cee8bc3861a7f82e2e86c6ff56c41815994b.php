<?php $__env->startSection('title',$decree->$title!=null?$decree->$title:trans('home.not_available')); ?>
<?php $__env->startSection('content'); ?>
  <?php if($decree->$title!=null): ?>
    <p class="meta" style="font-weight: bold;font-size: 1.1em;"><?php echo e($jdate->detailedDate($decree->$date,$lang)); ?></p>
    <div class="description">
      <p  class="printable"><?php echo $decree->$description; ?></p>
    </div>
  <?php endif; ?>
...
<?php $__env->startPush('meta_tags'); ?>
  <?php $__env->startComponent('include.components.meta_tags'); ?>
    ...
    <?php $__env->slot('meta_description'); ?>
      <?php echo e(mb_substr(strip_tags($decree->$description),0,255,'utf-8')); ?>
