    ...
    <div class="column" id="footer_three_menus">
      <div class="ui three column stackable grid" id="menus">
        ...
        <div class="column" id="footer_media">
          ...
          <a href="{{url($lang.'/home')}}" class="ui {{$dir}} floated tiny header body_font footer_link" style="width:100%;margin:5px 0;">{{trans('menu.home')}}</a>
          <a href="{{url($lang.'/news')}}" class="ui {{$dir}} floated tiny header body_font footer_link" style="width:100%;margin:5px 0;">{{trans('menu.news')}}</a>
          <a href="{{url($lang.'/articles')}}" class="ui {{$dir}} floated tiny header body_font footer_link" style="width:100%;margin:5px 0;">{{trans('menu.articles')}}</a>
          <a href="{{url($lang.'/infographics')}}" class="ui {{$dir}} floated tiny header body_font footer_link" style="width:100%;margin:5px 0;">{{trans('menu.infographics')}}</a>
          <a href="{{url($lang.'/documents')}}" class="ui {{$dir}} floated tiny header body_font footer_link" style="width:100%;margin:5px 0;">{{trans('menu.reports_and_documents')}}</a>
          <a href="{{url($lang.'/photo_albums')}}" class="ui {{$dir}} floated tiny header body_font footer_link" style="width:100%;margin:5px 0;">{{trans('menu.photo_albums')}}</a>
          <a href="{{url($lang.'/videos')}}" class="ui {{$dir}} floated tiny header body_font footer_link" style="width:100%;margin:5px 0;">{{trans('menu.videos')}}</a>
          <a href="{{url($lang.'/links')}}" class="ui {{$dir}} floated tiny header body_font footer_link" style="width:100%;margin:5px 0;">{{trans('menu.links')}}</a>
        </div>
        <div class="column" id="footer_president">
          ...
          <a href="{{url($lang.'/decrees')}}" class="ui {{$dir}} floated tiny header body_font footer_link" style="width:100%;margin:5px 0">{{trans('menu.decrees')}}</a>
          <a href="{{url($lang.'/orders')}}" class="ui {{$dir}} floated tiny header body_font footer_link" style="width:100%;margin:5px 0">{{trans('menu.orders')}}</a>
          <a href="{{url($lang.'/statements')}}" class="ui {{$dir}} floated tiny header body_font footer_link" style="width:100%;margin:5px 0">{{trans('menu.statements')}}</a>
          <a href="{{url($lang.'/messages')}}" class="ui {{$dir}} floated tiny header body_font footer_link" style="width:100%;margin:5px 0">{{trans('menu.messages')}}</a>
          <a href="{{url($lang.'/words')}}" class="ui {{$dir}} floated tiny header body_font footer_link" style="width:100%;margin:5px 0">{{trans('menu.words')}}</a>
          <a href="{{url($lang.'/international_trips')}}" class="ui {{$dir}} floated tiny header body_font footer_link" style="width:100%;margin:5px 0">{{trans('menu.international_trips')}}</a>
          <a href="{{url($lang.'/domestic_trips')}}" class="ui {{$dir}} floated tiny header body_font footer_link" style="width:100%;margin:5px 0">{{trans('menu.domestic_trips')}}</a>
      ...
      @if (sizeof($news)!=0)
        @foreach($news as $item)
          ...
          <?php $url =  ($item->table_name=='documents')?asset('uploads/documents_'.$lang.'/'.$item->table_id.'.pdf'):''; ?>
              <a href="{{($item->table_name=='documents')?$url:url($lang.'/'.$item->type.'_details/'.$item->table_id)}}" class="ui {{$dir}} floated tiny header body_font news_title footer_link" style="margin:9px 0;width:100%;">{{$item->$title}}</a>
          @endif
        @endforeach
      @endif
      ...
      @if (sizeof($articles) != 0)
        @foreach($articles as $article)
          @if ($article->$title!=null)
            <a href="{{url($lang.'/article_details/'.$article->id)}}" class="ui {{$dir}} floated tiny header body_font footer_link" style="margin:9px 0;width:100%;">{{$article->$title}}</a>
          @endif
        @endforeach
