            ...
            <div class="content" style="border:0;!">
              <a href="{{url($lang.'/words')}}" class="header title_font test" style="font-size: 1.4em !important;{{$lang=='pa'?'line-height: 1.6 !important':''}}">{{trans('home.president_word')}}</a>
                @if ($word!=null)
                  ...
                  <div>
                    <p class="description body_font" style="padding-top:3px;text-align:justify;margin-top:10px;direction: {{$rtl}};">{{$word->$short_desc}}</p>
                  </div>
                @endif
            </div>
          </div>
          ...
          <div class="ui fluid card" style="">
            <div class="content">
              <div class="ui stackable centered grid" style="margin-top:42px;">
                ...
                <div class="row" style="margin:10px;">
                  <a class="twitter-follow-button" data-width="300" data-chrome="nofooter" data-height="200" href="https://twitter.com/OCS_AFG?ref_src=twsrc%5Etfw">Tweets by OCS_AFG</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
