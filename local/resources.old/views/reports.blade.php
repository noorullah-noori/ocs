      ...
      <div class="ui centered container grid" id="main" style="display: flex">
        ...
        <div class="sixteen wide tablet mobile eleven wide computer column">
          <div class="ui fluid card" style="">
            <div class="content">
              <h2 class="ui header title_font border">{{trans('menu.reports')}}</h2>
              <div class="ui items" style="">
                 @foreach($reports as $value)
                <div class="item">
                  <div class="other_pages_thumbnail">
                    <img src="{{asset('uploads/report/'.$value->image)}}" style="padding-left:8px;">
                  </div>
                  <div class="content">
                    <a href="{{url($lang.'/report_details/'.$value->id)}}" class="ui small header title_font">{{$value->$title}}</a>
                    <div class="meta">
