...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="{{ asset('local/vendor/unisharp/laravel-filemanager/public/img/folder.png') }}">
  <link rel="stylesheet" href="//maxcdn.bootstrapcdn.com/bootstrap/3.3.4/css/bootstrap.min.css">
  <link rel="stylesheet" href="//maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css">
  <link rel="stylesheet" href="{{ asset('local/vendor/unisharp/laravel-filemanager/public/css/cropper.min.css') }}">
  <style>{!! \File::get(base_path('vendor/unisharp/laravel-filemanager/public/css/lfm.css')) !!}</style>
  {{-- Use the line below instead of the above if you need to cache the css. --}}
  {{-- <link rel="stylesheet" href="{{ asset('/vendor/unisharp/laravel-filemanager/css/lfm.css') }}"> --}}
  <link rel="stylesheet" href="{{ asset('local/vendor/unisharp/laravel-filemanager/public/css/mfb.css') }}">
  <link rel="stylesheet" href="{{ asset('local/vendor/unisharp/laravel-filemanager/public/css/dropzone.min.css') }}">
  <link rel="stylesheet" href="{{ asset('local/vendor/unisharp/laravel-filemanager/public/css/jquery-ui.min.css') }}">
</head>
<body>
  ...
  <div id="lfm-loader">
    <img src="{{asset('local/vendor/unisharp/laravel-filemanager/public/img/loader.svg')}}">
  </div>

  <script src="{{ asset('local/vendor/unisharp/laravel-filemanager/public/js/jquery.min.js') }}"></script>
  <script src="{{ asset('local/vendor/unisharp/laravel-filemanager/public/js/bootstrap.min.js')}}"></script>
  <script src="{{ asset('local/vendor/unisharp/laravel-filemanager/public/js/bootbox.min.js')}}"></script>
  <script src="{{ asset('local/vendor/unisharp/laravel-filemanager/public/js/jquery-ui.min.js')}}"></script>
  <script src="{{ asset('local/vendor/unisharp/laravel-filemanager/public/js/cropper.min.js') }}"></script>
  <script src="{{ asset('local/vendor/unisharp/laravel-filemanager/public/js/jquery.form.min.js') }}"></script>
  <script src="{{ asset('local/vendor/unisharp/laravel-filemanager/public/js/dropzone.min.js') }}"></script>
  <script>
  ...
  {{-- <script src="{{ asset('local/vendor/unisharp/laravel-filemanager/public/js/script.js') }}"></script> --}}
  <script>
    $.fn.fab = function () {
      var menu = this;
